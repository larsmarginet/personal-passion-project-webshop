        ...
        <v-row class="pl-3">
            <v-col style="width: 25%; maxWidth: 100px">
             ...
             <v-col style="width: 75%" class="card-grid px-0">
                <v-card-title class="py-0 pl-0 pr-5" style="lineHeight: 1">{{item.name}}<span class="ml-2 primary--text" v-if="item.selectedOption"> {{item.selectedOption}}</span></v-card-title>
